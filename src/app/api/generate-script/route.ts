  ...
  try {
    ...
    const prompt = `
      ...
      **[9가지 분석 및 생성 규칙 (엄격 준수)]**
      ...
      5. **최소한의 뼈대 공식 (공식 간소화 및 한국어 용어 활용)**: 구체적인 명사나 수식어는 걷어내고 어디든 갈아 끼울 수 있는 **최소한의 범용 공식**만 추출한다. 문장이 길더라도 공식은 아주 짧고 단순해야 한다.
         ...
         - **[안티 패턴 (금지)]**: \`[주어][동사][목적어]\` 처럼 모든 단어를 한국어 태그로만 채워 넣지 마라. 이는 패턴으로서 가치가 없다. 반드시 문법적 장치나 연결어는 생존시켜야 한다.
         - **[용어 매핑 가이드]**:
            *   Chủ ngữ / Subject -> **[주어]**
         ...
         - **[작성 예시]**:
            *   (X) [감탄사] [감탄사]. [주어] [동사] [상대방] [동사] [무엇] [의문사]? (절대 금지: 태그만 나열됨)
            *   (O) [감탄사] à... [주어] muốn [상대방] giúp [무엇] không? (핵심 키워드 'muốn', 'giúp', 'không' 유지)
            *   (O) Although [주어] [동사], [주어] still [동사] (영어 키워드 유지)
