  ...
  try {
    ...
    const prompt = `
      ...
      **[8가지 분석 규칙]**
      ...
      5. **최소한의 뼈대 공식 (한국어 문법 용어 전용)**: 구체적인 명사나 수식어는 걷어내고 어디든 갈아 끼울 수 있는 최소한의 공식만 추출한다. **변수명으로 베트남어/영어 용어를 쓰는 것을 엄격히 금지하며, 반드시 아래의 한국어 매핑 가이드를 따른다.**
         - **[용어 매핑 가이드 (필수)]**:
            *   Chủ ngữ / Subject -> **[주어]**
            ...
            *   Trạng từ / Adverb -> **[부사]**
            *   Cụm từ / Phrase -> **[문구]**
         - (X) [Danh từ số nhiều] như [Danh từ 1]...
         - (O) [복수 명사] như [명사 1], [명사 2]...
